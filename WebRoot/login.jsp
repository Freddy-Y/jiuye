...
<body>
	...
	<table width="559" height="423" border="0" align="center"
		...
		<tr>
			<td><div align="center"
					style="FONT-WEIGHT: bold; FONT-SIZE: 30pt;">在线就业招聘系统</div></td>
		</tr>
		<tr>
			<td width="559">
					...
					<table width="410" height="198" border="0" align="right"
						...
						<tr>
							<td height="31" colspan="2" valign="top" class="STYLE15">
								密&nbsp;码： <input name="userPw" type="password" size="21"
						...
						<tr>
							<td colspan="2" valign="top">&nbsp; &nbsp; &nbsp; &nbsp; <input
								name="button" type="button" class="submit1" value="登录"
								onClick="check1()"> &nbsp; <input name="Submit2"
								type="reset" class="submit1" value="重置"> <img
								id="indicator" src="<%=path%>/img/loading.gif"
								style="display:none" />
							</td>
						</tr>
					</table>
