	...
	<head>
        ...
        <script language="javascript">
            function check()
            {
                 ...
                 if(document.formPw.userNewPwRe.value != document.formPw.userNewPw.value)
                 {
                     alert("两次输入的密码不一致");
                     return ;
                 }
	...
	<body leftmargin="2" topmargin="9" background='<%=path %>/img/allbg.gif'>
			...
			<table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
				...
				<tr bgcolor="#FFFFFF">
				    ...
				    <td width="75%" bgcolor="#FFFFFF">
				        <input type="password" id="userPw1" name="userNewPw" size="22"/>
				    </td>
				</tr>
				<tr bgcolor="#FFFFFF">
				    <td width="25%" bgcolor="#FFFFFF" align="right">
				    ...
				    <td width="75%" bgcolor="#FFFFFF">
				        <input type="password" id="userPw2" name="userNewPwRe" size="22"/>
				    </td>
				</tr>
				<tr bgcolor="#FFFFFF">
				    <td width="25%" bgcolor="#FFFFFF" align="right">
